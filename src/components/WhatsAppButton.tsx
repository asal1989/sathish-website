...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-3 max-w-xs relative animate-fade-in-up">
          <button
      ...
      <a
        ...
        className="whatsapp-btn w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-xl transition-transform hover:scale-110"
        onClick={() => setShowTooltip(false)}
      >
